...
/*
1、依据角度与脉冲的关系，设置高电平时间为500微秒,控制舵机向右旋转0度。
2、发送10次脉冲信号。
*/
...
/*
1、依据角度与脉冲的关系，设置高电平时间为1000微秒,控制舵机向右旋转45度。
2、发送10次脉冲信号。
*/
...
{
    osThreadId_t thread1,thread2,thread3;
    GpioInit();//初始化GPIO
    ...
    osThreadAttr_t  attr;
    osThreadId_t thread1 = NULL;
    osThreadId_t thread2 = NULL;
    osThreadId_t thread3 = NULL;
